...
- Generated at (UTC): `2026-04-20T17:12:07.245808+00:00`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [View](details/bindings-java) | `com.daml:bindings-java` | `java` | `3.4.10, 3.4.11` | `1453` | `2` | `2` | `1` |
| [View](details/bindings-scala-2-13) | `com.daml:bindings-scala_2.13` | `scala` | `2.10.2, 2.10.3` | `321` | `0` | `0` | `0` |

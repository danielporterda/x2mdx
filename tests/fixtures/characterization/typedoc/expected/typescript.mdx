...
| --- | --- | --- | --- | --- |
| [`Choice`](#interface-choice) | Interface | `3.4.10` | - | - |
| [`ChoiceFrom`](#interface-choicefrom) | Interface | `3.4.10` | - | - |
| [`ContractTypeCompanion`](#interface-contracttypecompanion) | Interface | `3.4.10` | - | - |
| [`FromTemplate`](#interface-fromtemplate) | Interface | `3.4.10` | - | - |
| [`Map`](#interface-map) | Interface | `3.4.10` | - | - |
| [`Serializable`](#interface-serializable) | Interface | `3.4.10` | - | - |
| [`Template`](#interface-template) | Interface | `3.4.10` | - | - |
| [`ToInterface`](#interface-tointerface) | Interface | `3.4.10` | - | - |
| [`Unit`](#interface-unit) | Interface | `3.4.10` | - | - |
| [`Bool`](#type-alias-bool) | Type Alias | `3.4.10` | - | - |
| [`ContractId`](#type-alias-contractid) | Type Alias | `3.4.10` | - | - |
| [`Date`](#type-alias-date) | Type Alias | `3.4.10` | - | - |
| [`Decimal`](#type-alias-decimal) | Type Alias | `3.4.10` | - | - |
| [`DisclosedContract`](#type-alias-disclosedcontract) | Type Alias | `3.4.10` | - | - |
| [`Int`](#type-alias-int) | Type Alias | `3.4.10` | - | - |
| [`Interface`](#type-alias-interface) | Type Alias | `3.4.10` | - | - |
| [`InterfaceCompanion`](#type-alias-interfacecompanion) | Type Alias | `3.4.10` | - | - |
| [`List`](#type-alias-list) | Type Alias | `3.4.10` | - | - |
| [`Numeric`](#type-alias-numeric) | Type Alias | `3.4.10` | - | - |
| [`Optional`](#type-alias-optional) | Type Alias | `3.4.10` | - | - |
| [`Party`](#type-alias-party) | Type Alias | `3.4.10` | - | - |
| [`TemplateOrInterface`](#type-alias-templateorinterface) | Type Alias | `3.4.10` | - | - |
| [`Text`](#type-alias-text) | Type Alias | `3.4.10` | - | - |
| [`TextMap`](#type-alias-textmap) | Type Alias | `3.4.10` | - | - |
| [`Time`](#type-alias-time) | Type Alias | `3.4.10` | - | - |
| [`Bool`](#variable-bool) | Variable | `3.4.10` | - | - |
| [`Date`](#variable-date) | Variable | `3.4.10` | - | - |
| [`Decimal`](#variable-decimal) | Variable | `3.4.10` | - | - |
| [`Int`](#variable-int) | Variable | `3.4.10` | - | - |
| [`Party`](#variable-party) | Variable | `3.4.10` | - | - |
| [`Text`](#variable-text) | Variable | `3.4.10` | - | - |
| [`Time`](#variable-time) | Variable | `3.4.10` | - | - |
| [`Unit`](#variable-unit) | Variable | `3.4.10` | - | - |
| [`ContractId`](#function-contractid) | Function | `3.4.10` | - | - |
| [`emptyMap`](#function-emptymap) | Function | `3.4.10` | - | - |
| [`List`](#function-list) | Function | `3.4.10` | - | - |
| [`Map`](#function-map) | Function | `3.4.10` | - | - |
| [`Numeric`](#function-numeric) | Function | `3.4.10` | - | - |
| [`Optional`](#function-optional) | Function | `3.4.10` | - | - |
| [`TextMap`](#function-textmap) | Function | `3.4.10` | - | - |

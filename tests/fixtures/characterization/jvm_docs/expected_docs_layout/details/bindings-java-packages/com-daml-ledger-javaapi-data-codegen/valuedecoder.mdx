...
| --- | --- | --- | --- | --- |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.4.11/com/daml/ledger/javaapi/data/codegen/ValueDecoder.html#decode%28com.daml.ledger.javaapi.data.Value%29>) | `decode(Value)` | `3.4.10` | - | - |

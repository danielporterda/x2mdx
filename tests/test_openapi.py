...
class OpenApiLifecycleTests(unittest.TestCase):
    ...
    def test_render_pages_from_report_round_trip(self) -> None:
        ...
        self.assertIn("[`/ping`](#endpoint-get-ping)", spec_page)
        self.assertIn('<a id="endpoint-get-ping"></a>', spec_page)
        self.assertIn("| [`/ping`](#endpoint-get-ping) | `GET` | Ping endpoint | `v0.1.0` | v0.1.1:", spec_page)
        ...
        self.assertLess(spec_page.index("Table of Contents"), spec_page.index("Spec Metadata"))
